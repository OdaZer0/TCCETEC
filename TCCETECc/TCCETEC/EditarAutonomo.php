    ...
    <div class="card shadow-lg rounded">
        <div class="card-body">
            <form action="EditarAutonomo.php" method="POST">
                ...
                <div class="row mb-4">
                    <!-- Campo Area de Atuação -->
                    <div class="col-md-6">
                        <div class="mb-3">
                            <label class="form-label">Area de Atuação:</label>
                            <input type="text" name="AreaAtuacao" class="form-control form-control-lg" value="<?php echo htmlspecialchars($user['AreaAtuacao']); ?>" required>
                        </div>
                    </div>
                </div>
                <div class="row mb-4">
                    <!-- Campo Nivel de Formação -->
                    <div class="col-md-6">
                        <div class="mb-3">
                            <label class="form-label">Nivel de Formação:</label>
                            <input type="text" name="NivelFormacao" class="form-control form-control-lg" value="<?php echo htmlspecialchars($user['NivelFormacao']); ?>" required>
                        </div>
                    </div>
                </div>
