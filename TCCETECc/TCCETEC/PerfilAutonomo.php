...
<div class="container">
    <h2 class="d-flex custom-font justify-content-center">Perfil do Autonomo</h2>
    <div class="row">
        <div class="col-md-6">
            <div class="mb-3">
    ...
    <div class="row">
        ...
        <div class="col-md-6">
            <div class="mb-3">
                ...
                <input type="text" class="form-control" value="<?php echo htmlspecialchars($user['AreaAtuacao']); ?>" disabled>
            </div>
        </div>
        <div class="col-md-6">
            <div class="mb-3">
                <label class="form-label">NIVEL DE FORMAÇÃO:</label>
                <input type="text" class="form-control" value="<?php echo htmlspecialchars($user['NivelFormacao']); ?>" disabled>
            </div>
        </div>
    </div>
